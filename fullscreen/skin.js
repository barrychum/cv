...
// Generated 週六 十月 10 23:10:23 2015
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._closemap__text=document.createElement('div');
		this._closemap.className='ggskin ggskin_textdiv';
		this._closemap.ggTextDiv=this._closemap__text;
		this._closemap.ggId="closemap";
		this._closemap.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._closemap.ggVisible=true;
		this._closemap.className='ggskin ggskin_text';
		this._closemap.ggType='text';
		hs ='position:absolute;';
		hs+='left: 284px;';
		hs+='top:  8px;';
		hs+='width: 95px;';
		...
		hs+='overflow: hidden;';
		hs+='overflow-y: auto;';
		this._closemap__text.setAttribute('style',hs);
		this._closemap__text.innerHTML="Close map";
		this._closemap.appendChild(this._closemap__text);
		this._closemap.onclick=function () {
			me._map.style[domTransition]='none';
			me._map.style.visibility='hidden';
			me._map.ggVisible=false;
		}
		this._map.appendChild(this._closemap);
